...
def calc_sent_scaled(section_title, sections='extracted_section_testS1s.csv', to_modify='basic_nlp_results.csv'):
    ...
    print(to_modify_df)
    print("Data for all 3 SENTIMENTS extracted from " + sections)
...
if __name__ == "__main__":
    ...
    # print(calc_sentiment(text))
    # print(parse_sent_data(data))
    # print(analyze_subjectivity(text))
...
start_threaded_task("RISK FACTORS", analyze_subjectivity_scaled_threaded, num_files=98)